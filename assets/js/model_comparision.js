...
"Volkswagen Virtus GT": {
  ...
  "Mahindra Tractors 575 DI SP Plus": {
      type: "Commercial",
      brand: "Tata",
  ...
  "Mahindra Tractors Yuvraj 215 NXT": {
      type: "Commercial",
      brand: "Mahindra",
  ...
  "Mahindra Tractors Novo 755 DI PP 4WD V1": {
      type: "Commercial",
      brand: "Mahindra",
  ...
  "Mahindra Tractors Yuvo Tech Plus 585 DI": {
      type: "Commercial",
      brand: "Mahindra",
  ...
  "Mahindra Tractors SP Plus Series": {
      type: "Commercial",
      brand: "Mahindra",
    ...
    "Tata Tech+ 475": {
      ...
      "Mahindra Tractors 5050 D": {
        "type": "Commercial",
        "brand": "Tata",
        "modelNameNumber": "Mahindra Tractors Mahindra Tractors 5050 D",
...
"Tata Harrier": {
  ...
  "Mahindra XEV 9e": {
    "type": "Passenger",
    "brand": "Mahindra",
    "description": "High-performance electric SUV with futuristic design and advanced features.",
    "features": ["Electric Drivetrain", "Advanced Driver Assistance Systems (ADAS)", "Panoramic Sunroof"],
    "modelNameNumber": "Mahindra XEV 9e Luxury Edition",
    "engineSpecifications": "Dual Electric Motor, All-Wheel Drive, 200 kW",  
    "fuelType": "Electric",  
    "transmissionType": "Automatic",  
    "seatingCapacity": "5",  
    "priceRange": "₹25 Lakh - ₹30 Lakh (expected ex-showroom)",  
    "mileageRange": "500 km (claimed range per charge)",  
    "safetyFeatures": "6 Airbags, ABS with EBD, Lane Keep Assist, Emergency Brake Assist",  
    "colorOptions": "Midnight Black, Crystal White, Azure Blue",  
    "dimensions": "Length: 4650 mm, Width: 1900 mm, Height: 1700 mm, Wheelbase: 2770 mm",  
    "performanceFeatures": "Regenerative Braking, Fast Charging (80% in 30 minutes)",  
    "interiorFeatures": "Vegan Leather Seats, 12-inch Touchscreen, Digital Driver Display, Ambient Lighting",  
    "exteriorFeatures": "LED Headlamps, Aerodynamic Design, 19-inch Alloy Wheels",  
    "warrantyAfterSalesService": "3 years/1,00,000 km warranty with dedicated EV service support",  
    "releaseDateYear": "2024",  
  ...
  "Jeep Avenger": {
    "type": "Passenger",
    "brand": "Jeep",
    "description": "Compact electric SUV with rugged build and off-road capabilities.",
    "features": ["Electric Drivetrain", "Trail Rated Capability", "Adaptive Cruise Control"],
    "modelNameNumber": "Jeep Avenger EV",
    "engineSpecifications": "Single Electric Motor, 115 kW",  
    "fuelType": "Electric",  
    "transmissionType": "Automatic",  
    "seatingCapacity": "5",  
    "priceRange": "₹20 Lakh - ₹25 Lakh (expected ex-showroom)",  
    "mileageRange": "400 km (claimed range per charge)",  
    "safetyFeatures": "7 Airbags, ESC, Hill Descent Control, Forward Collision Warning",  
    "colorOptions": "Granite Crystal, Solar Yellow, Alpine White",  
    "dimensions": "Length: 4080 mm, Width: 1780 mm, Height: 1530 mm, Wheelbase: 2560 mm",  
    "performanceFeatures": "Selectable Drive Modes (Normal, Eco, Sport, Snow, Mud)",  
    "interiorFeatures": "Premium Fabric Upholstery, 10.25-inch Infotainment System, Wireless Charging",  
    "exteriorFeatures": "LED Lighting, Skid Plates, 17-inch Alloy Wheels",  
    "warrantyAfterSalesService": "3 years/1,00,000 km warranty with Jeep assistance program",  
    "releaseDateYear": "2024",  
    "imageUrl": "assets/images/vehicle_models_images/Jeep_Avenger.png"
  },
  "Maruti Suzuki e Vitara": {
    "type": "Passenger",
    "brand": "Maruti Suzuki",
    "description": "Affordable electric compact SUV with modern styling and practicality.",
    "features": ["Electric Drivetrain", "Connected Car Technology", "Push Button Start"],
    "modelNameNumber": "Maruti Suzuki e Vitara ZXI+",
    "engineSpecifications": "Electric Motor, 100 kW",  
    "fuelType": "Electric",  
    "transmissionType": "Automatic",  
    "seatingCapacity": "5",  
    "priceRange": "₹12 Lakh - ₹15 Lakh (expected ex-showroom)",  
    "mileageRange": "350 km (claimed range per charge)",  
    "safetyFeatures": "Dual Airbags, ABS with EBD, Reverse Parking Camera, ESP",  
    "colorOptions": "Nexa Blue, Magma Grey, Arctic White",  
    "dimensions": "Length: 4300 mm, Width: 1790 mm, Height: 1640 mm, Wheelbase: 2600 mm",  
    "performanceFeatures": "Fast Charging, Regenerative Braking",  
    "interiorFeatures": "SmartPlay Pro+ Infotainment, 7-inch Display, Automatic Climate Control",  
    "exteriorFeatures": "LED Projector Headlamps, Roof Rails, 16-inch Alloy Wheels",  
    "warrantyAfterSalesService": "2 years/75,000 km warranty with extended options",  
    "releaseDateYear": "2024",  
    "imageUrl": "assets/images/vehicle_models_images/Maruti_Suzuki_e_Vitara.png"
  },
  "Tata Avinya": {
    "type": "Passenger",
    "brand": "Tata",
    "description": "Futuristic electric SUV concept designed for sustainable mobility.",
    "features": ["Advanced Autonomous Driving Features", "Panoramic Glass Roof", "Ultramodern Design"],
    "modelNameNumber": "Tata Avinya Concept",
    "engineSpecifications": "Electric Motor, Gen 3 EV Architecture",  
    "fuelType": "Electric",  
    "transmissionType": "Automatic",  
    "seatingCapacity": "5",  
    "priceRange": "₹30 Lakh - ₹35 Lakh (expected ex-showroom)",  
    "mileageRange": "500 km (claimed range per charge)",  
    "safetyFeatures": "6 Airbags, Advanced Driver Assistance Systems, Collision Avoidance",  
    "colorOptions": "Concept Grey",  
    "dimensions": "Length: 4550 mm, Width: 1900 mm, Height: 1650 mm, Wheelbase: 2800 mm",  
    "performanceFeatures": "Ultra-Fast Charging, Eco-Friendly Materials",  
    "interiorFeatures": "Minimalist Dashboard, Premium Seating, Intelligent Display Screens",  
    "exteriorFeatures": "LED Blade Lights, Sleek Profile, Aerodynamic Panels",  
    "warrantyAfterSalesService": "Concept stage, details pending",  
    "releaseDateYear": "2025 (expected)",  
    "imageUrl": "assets/images/vehicle_models_images/Tata_Avinya.png"
  },
  "Mahindra Be 6": {
    "type": "Passenger",
    "brand": "Mahindra",
    "description": "Stylish electric SUV with cutting-edge technology and impressive range.",
    "features": ["Electric Drivetrain", "Autonomous Driving Features", "Panoramic Sunroof"],
    "modelNameNumber": "Mahindra Be 6 Premium",
    "engineSpecifications": "Dual Electric Motor, 220 kW",  
    "fuelType": "Electric",  
    "transmissionType": "Automatic",  
    "seatingCapacity": "5",  
    "priceRange": "₹28 Lakh - ₹32 Lakh (expected ex-showroom)",  
    "mileageRange": "600 km (claimed range per charge)",  
    "safetyFeatures": "6 Airbags, ABS with EBD, Lane Departure Warning, Blind Spot Detection",  
    "colorOptions": "Ocean Blue, Pearl White, Volcano Black",  
    "dimensions": "Length: 4700 mm, Width: 1950 mm, Height: 1600 mm, Wheelbase: 2800 mm",  
    "performanceFeatures": "Ultra-Fast Charging, Adaptive Regenerative Braking",  
    "interiorFeatures": "AI-Powered Assistance, Augmented Reality HUD, Premium Vegan Leather",  
    "exteriorFeatures": "Illuminated Grille, Sleek LED Tail Lamps, 20-inch Alloy Wheels",  
    "warrantyAfterSalesService": "3 years/1,00,000 km warranty with EV-specific support",  
    "releaseDateYear": "2024",  
    "imageUrl": "assets/images/vehicle_models_images/Mahindra_Be_6.png"
  }
...
// Populate dropdowns with vehicle options
const vehicle1Dropdown = document.getElementById("vehicle1");
const vehicle2Dropdown = document.getElementById("vehicle2");

Object.keys(vehicleData).forEach((vehicle) => {
  const option1 = new Option(vehicle, vehicle);
  const option2 = new Option(vehicle, vehicle);
  vehicle1Dropdown.add(option1);
...
const ATTRIBUTE_LABELS = {
  ...
  engineSpecifications: "Engine", fuelType: "Fuel Type", transmissionType: "Transmission",
  seatingCapacity: "Seating Capacity", priceRange: "Price Range", mileageRange: "Mileage",
  safetyFeatures: "Safety Features", colorOptions: "Color Options", dimensions: "Dimensions",
  performanceFeatures: "Performance", interiorFeatures: "Interior Features",
  exteriorFeatures: "Exterior Features", releaseDateYear: "Release Year",
  warrantyAfterSalesService: "Warranty & After-Sales", imageUrl: "Image"
};
...
function compareVehicles() {
  ...
  const vehicle2 = vehicle2Dropdown.value;

  if (vehicle1 === "none" || vehicle2 === "none") {
  ...
  document.getElementById("th-v1").textContent = vehicle1;
  document.getElementById("th-v2").textContent = vehicle2;

  const rowsHtml = [];
  for (const attribute in data1) {
    if (attribute === "imageUrl") continue;
    const label = ATTRIBUTE_LABELS[attribute] || (attribute.charAt(0).toUpperCase() + attribute.slice(1));
    const v1 = data1[attribute];
    const v2 = data2 ? data2[attribute] : "";
    const isDiff = v1 !== v2;
    const row = document.createElement("tr");
    row.innerHTML = `
      <td>${label}</td>
      <td class="${isDiff ? "diff" : ""}">${v1}</td>
      <td class="${isDiff ? "diff" : ""}">${v2}</td>
    `;
    comparisonBody.appendChild(row);
    rowsHtml.push({ label, v1, v2, isDiff });
  }

  // ---- Sticky header (image + name for both vehicles) ----
  const sticky = document.getElementById("compare-sticky");
  sticky.classList.add("is-active");
  sticky.innerHTML = `
    <div class="compare-sticky__side">
      <img src="${safeImg(data1.imageUrl)}" alt="${vehicle1}" onerror="this.src='assets/logo/vehiclelogo1.jpg'">
      <strong>${vehicle1}</strong>
    </div>
    <span class="compare-sticky__vs">VS</span>
    <div class="compare-sticky__side" style="justify-content:flex-end;text-align:right">
      <strong>${vehicle2}</strong>
      <img src="${safeImg(data2.imageUrl)}" alt="${vehicle2}" onerror="this.src='assets/logo/vehiclelogo1.jpg'">
    </div>
  `;

  // ---- Mobile swipeable card carousel (one card per vehicle) ----
  const buildCard = (name, data) => `
    <div class="compare-card">
      <div class="compare-card__head">
        <img src="${safeImg(data.imageUrl)}" alt="${name}" onerror="this.src='assets/logo/vehiclelogo1.jpg'">
        <h3>${name}</h3>
      </div>
      ${rowsHtml.map(r => `
        <div class="compare-row ${r.isDiff ? "diff" : ""}">
          <span>${r.label}</span>
          <span>${data === data1 ? r.v1 : r.v2}</span>
        </div>
      `).join("")}
    </div>
  `;
  const mobileContainer = document.getElementById("compare-mobile-cards");
  mobileContainer.innerHTML = buildCard(vehicle1, data1) + buildCard(vehicle2, data2);

  // Dots + swipe-tracking for the mobile carousel
  const dotsContainer = document.getElementById("compare-mobile-dots");
  dotsContainer.innerHTML = `<span class="is-active"></span><span></span>`;
  const dots = dotsContainer.querySelectorAll("span");
  mobileContainer.onscroll = () => {
