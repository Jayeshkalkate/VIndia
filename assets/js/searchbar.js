...
document.getElementById("search-bar").addEventListener(
  ...
  debounce(() => {
      ...
      if (query) {
          ...
          const matchingVehicles = Object.keys(vehicleDetails).filter(vehicle =>
              vehicle.toLowerCase().includes(query)
          );

          // Show suggestions if there are matches
          if (matchingVehicles.length > 0) {
              suggestionsDiv.innerHTML = matchingVehicles
                  .map(vehicle => `<p class="suggestion-item">${vehicle}</p>`)
                  .join("");
              suggestionsDiv.style.display = "block";

              // Align suggestions box with the search bar
              const searchBar = document.getElementById("search-bar");
              const searchBarRect = searchBar.getBoundingClientRect();
              suggestionsDiv.style.width = `${searchBarRect.width}px`;
...
function searchVehicle(query) {
  ...
  if (query) {
      ...
      const matchingVehicle = Object.keys(vehicleDetails).find(
          vehicle => vehicle.toLowerCase() === query.toLowerCase()
      );
      ...
      if (matchingVehicle) {
          ...
          resultsDiv.innerHTML = `
              <table class="vehicle-table">
                  ...
                  <tbody>
                      <tr><td><strong>Model</strong></td><td>${matchingVehicle}</td></tr>
                      <tr><td><strong>Brand</strong></td><td>${vehicle.brand}</td></tr>
                      <tr><td><strong>Type</strong></td><td>${vehicle.type}</td></tr>
                      <tr><td><strong>Engine</strong></td><td>${vehicle.engineSpecifications}</td></tr>
                      ...
                      <tr><td><strong>Seating Capacity</strong></td><td>${vehicle.seatingCapacity}</td></tr>
                      <tr><td><strong>Price Range</strong></td><td>${vehicle.priceRange}</td></tr>
                      <tr><td><strong>Mileage</strong></td><td>${vehicle.mileageRange}</td></tr>
                      <tr><td><strong>Safety Features</strong></td><td>${vehicle.safetyFeatures}</td></tr>
                      <tr><td><strong>Color Options</strong></td><td>${vehicle.colorOptions}</td></tr>
                      <tr><td><strong>Dimensions</strong></td><td>${vehicle.dimensions}</td></tr>
                      <tr><td><strong>Performance</strong></td><td>${vehicle.performanceFeatures}</td></tr>
                      <tr><td><strong>Interior</strong></td><td>${vehicle.interiorFeatures}</td></tr>
                      <tr><td><strong>Exterior</strong></td><td>${vehicle.exteriorFeatures}</td></tr>
                      <tr><td><strong>Warranty</strong></td><td>${vehicle.warrantyAfterSalesService}</td></tr>
                      <tr><td><strong>Release Year</strong></td><td>${vehicle.releaseDateYear}</td></tr>
                      <tr>
