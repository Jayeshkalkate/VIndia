...
<<<<<<< HEAD
        vehicleInfoContainer.innerHTML = `
          <div class="empty-state">
            ...
            <p>We don't have specifications for the selected model yet.</p>
          </div>`;
        return;
    }

    // Build a rich, chunked result card: quick chips + spec grid + accordion sections
    const fuelIcon = /electric/i.test(vehicleDetails.fuelType || "") ? "fa-bolt"
                    : /diesel/i.test(vehicleDetails.fuelType || "") ? "fa-gas-pump"
                    : "fa-gas-pump";

    const detailsHTML = `
        <div class="vehicle-section reveal is-visible">
            <img src="${vehicleDetails.imageUrl}" alt="${vehicleModel} photo" class="vehicle-image"
                 onerror="this.src='assets/logo/vehiclelogo1.jpg'"/>

            <div class="vehicle-details">
                <h2>${vehicleModel}</h2>
                <div class="chip-row">
                    <span class="chip chip-accent"><i class="fa-solid fa-tag"></i> ${vehicleDetails.brand}</span>
                    <span class="chip chip-blue"><i class="fa-solid ${fuelIcon}"></i> ${vehicleDetails.fuelType}</span>
                    <span class="chip"><i class="fa-solid fa-gears"></i> ${vehicleDetails.transmissionType}</span>
                    <span class="chip chip-green"><i class="fa-solid fa-chair"></i> ${vehicleDetails.seatingCapacity} Seats</span>
                </div>

                <div class="spec-grid">
                    <div class="spec-item"><span><i class="fa-solid fa-indian-rupee-sign"></i> Price Range</span><strong>${vehicleDetails.priceRange}</strong></div>
                    <div class="spec-item"><span><i class="fa-solid fa-road"></i> Mileage</span><strong>${vehicleDetails.mileageRange}</strong></div>
                    <div class="spec-item"><span><i class="fa-solid fa-calendar"></i> Launch Year</span><strong>${vehicleDetails.releaseDateYear}</strong></div>
                    <div class="spec-item"><span><i class="fa-solid fa-hashtag"></i> Model No.</span><strong>${vehicleDetails.modelNameNumber}</strong></div>
                </div>

                <div class="accordion" id="specAccordion">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#accEngine">
                                <i class="fa-solid fa-gauge-high" style="margin-right:10px;color:var(--accent)"></i> Engine &amp; Performance
                            </button>
                        </h2>
                        <div id="accEngine" class="accordion-collapse collapse show" data-bs-parent="#specAccordion">
                            <div class="accordion-body">
                                <p><strong>Engine:</strong> ${vehicleDetails.engineSpecifications}</p>
                                <p><strong>Performance Features:</strong> ${vehicleDetails.performanceFeatures}</p>
                                <p><strong>Dimensions:</strong> ${vehicleDetails.dimensions || "—"}</p>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#accSafety">
                                <i class="fa-solid fa-shield-halved" style="margin-right:10px;color:var(--accent)"></i> Safety &amp; Colors
                            </button>
                        </h2>
                        <div id="accSafety" class="accordion-collapse collapse" data-bs-parent="#specAccordion">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#accCabin">
                                <i class="fa-solid fa-couch" style="margin-right:10px;color:var(--accent)"></i> Interior &amp; Exterior
                            </button>
                        </h2>
                        <div id="accCabin" class="accordion-collapse collapse" data-bs-parent="#specAccordion">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#accWarranty">
                                <i class="fa-solid fa-file-shield" style="margin-right:10px;color:var(--accent)"></i> Warranty &amp; After-Sales
                            </button>
                        </h2>
                        <div id="accWarranty" class="accordion-collapse collapse" data-bs-parent="#specAccordion">
                            <div class="accordion-body">
                                <p>${vehicleDetails.warrantyAfterSalesService}</p>
                            </div>
                        </div>
                    </div>
                </div>
